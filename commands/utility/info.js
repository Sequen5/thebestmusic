...
module.exports = {
    ...
    `)
            ...
            .addField("***BOT BY:***", `
    >>> <@399486777066520577>  \`Sequen\` [\`Website\`](https://discord.gg/tQHqxh9D5R)
    `).addField("***SUPPORT:***", `
    >>> [\`Server\`](https://discord.gg/tQHqxh9D5R) | [\`Invite\`](https://discordapp.com/oauth2/authorize?client_id=660449158599016457&scope=bot&permissions=8)
    `)
